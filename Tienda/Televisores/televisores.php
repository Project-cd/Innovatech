...
<head>
    ...
    <link rel="stylesheet" href="televisores.css">
</head>
<body>
    <header>
    ...
    <section class="categories">
        <div class="category-list">
            ...
            <a href="../Tablets/tablets.php">Tablets</a>
    ...
    <section class="products">
        ...
        <div class="product-list">
            ...
            $sql = "SELECT * FROM productos WHERE categoria = 'televisores'";
    ...
    <script src="televisores.js"></script> <!-- Asegúrate de que este archivo esté correctamente enlazado -->
</body>
</html>